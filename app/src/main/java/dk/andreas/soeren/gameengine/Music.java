...
public class Music implements MediaPlayer.OnCompletionListener {
    ...
    public Music(AssetFileDescriptor assetFileDescribtor)
    {
        mediaPlayer = new MediaPlayer();
        try
        {
            mediaPlayer.setDataSource(assetFileDescribtor.getFileDescriptor(),
                    assetFileDescribtor.getStartOffset(),assetFileDescribtor.getLength());
            mediaPlayer.prepare();
            isPrepared = true;
